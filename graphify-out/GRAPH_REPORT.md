...
## Corpus Check
- 134 files · ~87,025 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1833 nodes · 4354 edges · 139 communities (93 shown, 46 thin omitted)
- Extraction: 72% EXTRACTED · 28% INFERRED · 0% AMBIGUOUS · INFERRED: 1233 edges (avg confidence: 0.58)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d8caf30b`
...
Cohesion: 0.09
Nodes (51): _block_sources(), build_ignore_memory(), canonical_ignore_key(), clear_ignore_memory_cache(), default_ignore_memory(), _default_memory_candidates(), IgnoreMemory, load_ignore_memory() (+43 more)
...
Cohesion: 0.11
Nodes (46): _build_manifest_from_pages(), CorpusManifestEntry, _count_images_under(), describe_corpus_path(), _entry_from_manifest_row(), _entry_group_key(), find_corpus_candidates(), _find_manifest_file() (+38 more)

### Community 7 - "Community 7"
Cohesion: 0.14
Nodes (36): CorpusProcessResult, default_refreshed_path(), _is_zone_fallback_candidate(), _iter_refreshable_blocks(), main(), _refresh_blocks_with_rules(), refresh_review_project(), _refresh_zone_ocr_alternatives() (+28 more)
...
Cohesion: 0.09
Nodes (48): Translator, ProjectCache, from_images(), OcrBlock, PageRecord, ProjectData, A localized OCR block kept compatible with future bubble replacement., RiskBand (+40 more)
...
Cohesion: 0.26
Nodes (12): BlockFilter, block_display_source(), block_matches_filter(), block_matches_search(), BlockStats, page_block_stats(), project_stats(), ProjectStats (+4 more)
...
Cohesion: 0.25
Nodes (13): ReplayBlockResult, ReplayReport, FakeRecognizer, FakeTranslator, Path, test_bbox_iou(), test_failure_page_indices_reads_previous_replay_report(), test_parse_index_list_accepts_ranges_and_page_prefix() (+5 more)
