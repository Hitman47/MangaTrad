...
## Corpus Check
- 134 files · ~87,368 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1837 nodes · 4365 edges · 139 communities (94 shown, 45 thin omitted)
- Extraction: 72% EXTRACTED · 28% INFERRED · 0% AMBIGUOUS · INFERRED: 1236 edges (avg confidence: 0.58)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f8c5caa6`
...
Cohesion: 0.15
Nodes (33): EasyOcrEngine, bad_ocr_tokens(), from_dict(), OcrCandidate, word_tokens(), EasyOcrEngine, Free OCR backend using EasyOCR.      EasyOCR returns polygons, text and confiden, Free OCR backend using EasyOCR.      EasyOCR returns polygons, text and confiden (+25 more)
...
Cohesion: 0.07
Nodes (64): _bootstrap_basic(), _install_index_pairs(), main(), _print_pairs(), _test_translation(), Pattern, int, str (+56 more)
...
Cohesion: 0.13
Nodes (37): Translator, default_refreshed_path(), _is_zone_fallback_candidate(), _iter_refreshable_blocks(), main(), _refresh_blocks_with_rules(), refresh_review_project(), _refresh_zone_ocr_alternatives() (+29 more)
...
Cohesion: 0.09
Nodes (53): CorpusProcessResult, Recognizer, BlockFilter, BlockStats, page_block_stats(), ProjectCache, from_images(), OcrBlock (+45 more)
...
Cohesion: 0.23
Nodes (22): _failure_page_indices(), main(), _parse_index_list(), Protocol, bbox_iou(), _best_match(), canonical_text(), expected_source_is_translation_like() (+14 more)
...
Cohesion: 0.16
Nodes (26): _changed_or_reviewed(), discover_review_projects(), evaluate_block(), _predict_source(), _predict_translation(), RegressionItem, RegressionReport, run_review_regression() (+18 more)
...
Cohesion: 0.22
Nodes (14): block_display_source(), block_matches_filter(), block_matches_search(), project_stats(), ProjectStats, visible_blocks(), bool, OcrBlock (+6 more)
...
Cohesion: 0.23
Nodes (14): ReplayBlockResult, ReplayReport, FakeRecognizer, FakeTranslator, Path, test_bbox_iou(), test_failure_page_indices_reads_previous_replay_report(), test_parse_index_list_accepts_ranges_and_page_prefix() (+6 more)
...
Cohesion: 0.36
Nodes (7): build_learning_report(), _is_learnable(), LearningReport, _source_for_memory(), Any, OcrBlock, str
