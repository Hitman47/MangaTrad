...
## Corpus Check
- 134 files · ~87,775 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1842 nodes · 4375 edges · 138 communities (93 shown, 45 thin omitted)
- Extraction: 72% EXTRACTED · 28% INFERRED · 0% AMBIGUOUS · INFERRED: 1239 edges (avg confidence: 0.58)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0a615a3a`
...
Cohesion: 0.09
Nodes (52): CorpusProcessResult, _changed_or_reviewed(), BlockStats, page_block_stats(), ProjectCache, from_images(), OcrBlock, PageRecord (+44 more)
...
Cohesion: 0.21
Nodes (23): _failure_page_indices(), main(), _parse_index_list(), bbox_iou(), _best_match(), canonical_text(), expected_source_is_translation_like(), Recognizer (+15 more)
...
Cohesion: 0.17
Nodes (16): Recognizer, Translator, EasyOcrEngine, Free OCR backend using EasyOCR.      EasyOCR returns polygons, text and confiden, Free OCR backend using EasyOCR.      EasyOCR returns polygons, text and confiden, Protocol, bool, OcrBlock (+8 more)
...
Cohesion: 0.21
Nodes (15): BlockFilter, block_display_source(), block_matches_filter(), block_matches_search(), project_stats(), ProjectStats, visible_blocks(), bool (+7 more)
...
Cohesion: 0.31
Nodes (8): build_learning_report(), _is_learnable(), LearningReport, _source_for_memory(), Any, int, OcrBlock, str
