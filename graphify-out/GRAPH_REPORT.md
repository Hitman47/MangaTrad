...
## Summary
- 1609 nodes · 3850 edges · 107 communities (84 shown, 23 thin omitted)
- Extraction: 72% EXTRACTED · 28% INFERRED · 0% AMBIGUOUS · INFERRED: 1081 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8fbc1fb7`
...
1. `OcrBlock` - 222 edges
2. `ProjectData` - 112 edges
3. `ProjectCache` - 111 edges
4. `PageRecord` - 75 edges
5. `ArgosTranslator` - 75 edges
6. `EasyOcrEngine` - 52 edges
7. `TranslationQualityChecker` - 47 edges
8. `ReviewWindow` - 39 edges
9. `OcrFallbackEngine` - 38 edges
10. `OcrCandidate` - 34 edges
...
Cohesion: 0.07
Nodes (51): Match, Repair ellipses when reviewed manga dialogue consistently implies them.      Thi, repair_probable_dialogue_ellipsis(), Repair OCR confusions typical of narrow all-caps manga lettering.      These are, repair_manga_font_confusions(), has_random_ocr_casing(), _is_random_case_word(), normalize_english_ocr_casing() (+43 more)

### Community 4 - "Community 4"
Cohesion: 0.10
Nodes (48): _block_sources(), build_ignore_memory(), canonical_ignore_key(), clear_ignore_memory_cache(), default_ignore_memory(), _default_memory_candidates(), IgnoreMemory, load_ignore_memory() (+40 more)

### Community 5 - "Community 5"
Cohesion: 0.12
Nodes (46): _bootstrap_basic(), _install_index_pairs(), main(), _print_pairs(), _test_translation(), Pattern, int, str (+38 more)

### Community 6 - "Community 6"
Cohesion: 0.13
Nodes (43): _build_manifest_from_pages(), CorpusManifestEntry, _count_images_under(), describe_corpus_path(), _entry_from_manifest_row(), _entry_group_key(), find_corpus_candidates(), _find_manifest_file() (+35 more)

### Community 7 - "Community 7"
Cohesion: 0.10
Nodes (42): BlockFilter, BlockStats, page_block_stats(), ProjectCache, from_images(), OcrBlock, PageRecord, ProjectData (+34 more)
...
Cohesion: 0.18
Nodes (30): CorpusProcessResult, default_refreshed_path(), _is_zone_fallback_candidate(), _iter_refreshable_blocks(), main(), _refresh_blocks_with_rules(), refresh_review_project(), _refresh_zone_ocr_alternatives() (+22 more)
...
Cohesion: 0.22
Nodes (24): _failure_page_indices(), main(), _parse_index_list(), EasyOcrEngine, Free OCR backend using EasyOCR.      EasyOCR returns polygons, text and confiden, bbox_iou(), _best_match(), canonical_text() (+16 more)
...
Cohesion: 0.25
Nodes (12): ReplayBlockResult, FakeRecognizer, FakeTranslator, Path, test_bbox_iou(), test_failure_page_indices_reads_previous_replay_report(), test_parse_index_list_accepts_ranges_and_page_prefix(), test_replay_review_project_can_target_specific_page_indices() (+4 more)
...
## Knowledge Gaps
- **281 isolated node(s):** `PreToolUse`, `clean_repo.sh script`, `str`, `int`, `int` (+276 more)
...
- **Why does `OcrBlock` connect `Community 7` to `Community 0`, `Community 1`, `Community 2`, `Community 4`, `Community 5`, `Community 6`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 16`, `Community 17`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 25`, `Community 29`, `Community 35`, `Community 37`, `Community 55`?**
  _High betweenness centrality (0.246) - this node is a cross-community bridge._
- **Why does `CbzReader` connect `Community 1` to `Community 14`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `int` connect `Community 14` to `Community 1`, `Community 7`, `Community 43`, `Community 20`, `Community 25`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **Are the 219 inferred relationships involving `OcrBlock` (e.g. with `CorpusManifestEntry` and `CorpusProcessResult`) actually correct?**
  _`OcrBlock` has 219 INFERRED edges - model-reasoned connections that need verification._
- **Are the 109 inferred relationships involving `ProjectData` (e.g. with `CorpusManifestEntry` and `CorpusProcessResult`) actually correct?**
  _`ProjectData` has 109 INFERRED edges - model-reasoned connections that need verification._
- **Are the 110 inferred relationships involving `ProjectCache` (e.g. with `CorpusManifestEntry` and `CorpusProcessResult`) actually correct?**
  _`ProjectCache` has 110 INFERRED edges - model-reasoned connections that need verification._
- **Are the 71 inferred relationships involving `PageRecord` (e.g. with `CorpusManifestEntry` and `CorpusProcessResult`) actually correct?**
  _`PageRecord` has 71 INFERRED edges - model-reasoned connections that need verification._