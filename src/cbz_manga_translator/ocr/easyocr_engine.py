...
_SFX_LABEL_RE = re.compile(
    r"^(?:whisper|sob|shock|jaka|sfx|bam|bang|boom|thud|clap|rustle|slam|tap|tch|ugh|huh|hey|yeah|jolt|gasp|slap|wobble|yawn|sposh|flash|tremble|fidget|twitch|fwooo|woosh|crash|nod|scribble)[.!?:, -]*$",
    flags=re.IGNORECASE,
)
