...
_OCR_CORRECTIONS: tuple[tuple[re.Pattern[str], str], ...] = (
    ...
    (re.compile(r"^It'strynng\s+To\s+eliminate\s+Elizabeth[.]$", flags=re.IGNORECASE), "It's trying To eliminate Elizabeth."),
...
_DIALOGUE_NORMALIZATIONS: tuple[tuple[re.Pattern[str], str], ...] = (
    ...
    (re.compile(r"^It['â€™]?s\s+trying\s+To\s+eliminate\s+Elizabeth[.]$", flags=re.IGNORECASE), "it's trying to eliminate Elizabeth."),
    (re.compile(r"^The\s+ANOMALY\s+Who\s+has\s+Derailed\s+The\s+plot!$", flags=re.IGNORECASE), "the anomaly who has derailed the plot!"),
    (
        re.compile(
